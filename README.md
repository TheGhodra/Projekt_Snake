Um unser Snake Game starten zu können muss man die Datei "Projekt_Snake.py" und die Datei "buttons.py" mit den Ordnern Fonts, Hintergrund, Körper_Schlange, Memes, Sounds, Sprites und __pycache__ herunterladen.
